...
public:
	typedef boost::signals2::signal<VOID(TestItem2*, RECT*)> signal_GetCompExt;
	typedef boost::signals2::signal<VOID(TestItem2*, std::wstring)> signal_UpdateCompStr;
	typedef boost::signals2::signal<VOID(TestItem2*, std::wstring)> signal_CommitStr;
